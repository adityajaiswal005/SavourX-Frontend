...
const HeroSection = () => {
  return (
    <section id="heroSection" className="min-h-screen bg-dark relative overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
        {/* Left Content */}
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-12 justify-center lg:justify-start">
            <Link 
              ...
              smooth={true} 
              duration={500}
              className="group px-8 py-4 bg-gradient-to-r from-primary to-accent text-white font-semibold rounded-full cursor-pointer transition-all duration-300 inline-flex items-center gap-2 no-underline hover:-translate-y-2 hover:shadow-[0_20px_40px_40px_rgba(255,107,53,0.4)] flex-1 justify-center lg:justify-start"
            >
            ...
            <Link 
              ...
              smooth={true} 
              duration={500}
              className="group px-8 py-4 bg-white/5 border-2 border-white/20 text-white font-semibold rounded-full cursor-pointer transition-all duration-300 inline-flex items-center gap-2 no-underline hover:border-primary hover:text-primary hover:bg-white/10 flex-1 justify-center lg:justify-start"
            >
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 pt-10 justify-items-center lg:justify-items-start">
            <div className="text-center lg:text-left">
